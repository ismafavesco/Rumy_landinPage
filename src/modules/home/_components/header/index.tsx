        ...
        <div className="flex flex-col md:flex-row">
                  ...
                  <>
                    ...
                    <span className="inline-block relative">
                      ...
                      <motion.span
                        ...
                        className="w-0 h-full top-0 left-0 z-[-1] absolute inline-block bg-gradient-to-r from-primary/80 to-secondary/70 rounded-lg"
                      />
                    </span>{" "}
                    {header.headline
                      .split(" ")
          ...
          <div className="min-h-[300vh] z-[-1]" ref={ref}>
            <div className="flex justify-center sticky top-28 md:top-40">
              ...
              >
                <div className="absolute top-2.5 left-3 w-[calc(100%-24px)] h-[calc(100%-16px)] rounded-[3rem] overflow-hidden">
